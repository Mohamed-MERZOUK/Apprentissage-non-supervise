...
![Figure](./images/FigureACPbert.jpg)
![Figure](./images/FigureACPbert2.png)

# Analyse Factorielle Multiple (AFM) sur les 12 couches de BERT
![Figure](./images/FigureAFMbert.jpg)  

# Hierarchical clustering (CAH) sur BERT
![Figure](./images/FigureCAHbert.png)

# k-means clustering sur deux Datasets BERT (à 3/4 classes)
![Figure](./images/FigurekmeansBert.jpg)

# Evaluation par projection des classes réel sur l'ACP
![Figure](./images/FigureACPproj.jpg)

# Application de l'Analyse Factoriel Discriminante (AFD)
![Figure](./images/FigureAFD.jpg)
